					...
					<thead>
						<tr>
							...
							<td index=1><span>Status</span> <c:if
								...
								<div class="filter"></div></td>
							<td index=2><span>Name</span>
							<c:if test="${param.fil eq 'en'}">
									<span class="glyphicon glyphicon-collapse-down"></span>
								</c:if>
								<div class="filter"></div></td>
							<td index=3><span>Email</span>
							<c:if test="${param.fil eq 'en'}">
									<span class="glyphicon glyphicon-collapse-down"></span>
								</c:if>
								<div class="filter"></div></td>
							<td index=4><span>Role</span>
							<c:if test="${param.fil eq 'en'}">
									<span class="glyphicon glyphicon-collapse-down"></span>
								</c:if>
								<div class="filter"></div></td>
							<td index=5><span>password</span>
							<c:if test="${param.fil eq 'en'}">
									<span class="glyphicon glyphicon-collapse-down"></span>
								</c:if>
								<div class="filter"></div></td>
							<td index=6><span>DBA password</span>
							<c:if test="${param.fil eq 'en'}">
									<span class="glyphicon glyphicon-collapse-down"></span>
								</c:if>
								<div class="filter"></div></td>
